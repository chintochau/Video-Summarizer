      ...
      <div className=" bg-gray-50">
        <div className="flex justify-between px-3 pt-1">
          <div className=" flex flex-1 items-center gap-x-1 flex-wrap">
            ...
            <div>
              <Button
                className="h-8 w-8 text-sm text-indigo-600 flex items-center p-1"
                variant="ghost"
                onClick={() => {
