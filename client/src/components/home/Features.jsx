...
const Features = () => {
  ...
  const featuresContents = t("featuresContents", { returnObjects: true });
  const { features } = featuresContents;
  return (
    <section
      id="features"
    ...
    >
      <div className="container ">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-8 md:gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start ">
          <div className="md:px-6 my-auto">
            <h2 className="text-3xl md:text-4xl text-white font-display font-semibold">
              {featuresContents.headline}
            </h2>
            <p className="text-sm md:text-xl  text-gray-300 f ont-roboto font-normal max-w-3xl mt-4">
              ...
              return (
                ...
                >
                  ...
                  <div className=" ml-4">
                    ...
                    <p className=" text-sm text-gray-300 font-roboto font-normal mt-1">
            ...
            <div className=" text-left mt-12 px-10 hidden md:block">
              <LinkToDashboard>
                <Button variant="outline">{featuresContents.cta}</Button>
              </LinkToDashboard>
            </div>
          </div>
          <div className=" p-0.5 my-auto w-[48rem] h-[27.4rem] max-w-none rounded-xl shadow-xl ring-1 ring-gray-400/10 sm:w-[1427px] sm:h-[809px] bg-gradient-to-br from-cyan-500 to-indigo-900">
            <img
              src={screenshot}
              className="my-auto w-[48rem] max-w-none rounded-xl shadow-xl ring-1 ring-gray-400/10 sm:w-[1423px] "
            />
          </div>
