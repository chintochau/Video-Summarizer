                        ...
                        whyContents.why.map((feature, index) => {
                            ...
                            return (
                                <div
                                    ...
                                    key={index}>
                                    <h3 className="mt-4 md:hidden text-2xl md:text-3xl font-bold text-cyan-500">{feature.subheader}</h3>
                                    <img src={imgSrc} alt={feature.subheader} className=" object-cover w-full md:w-96 lg:w-full lg:px-8 aspect-[4/3]" />
                                    <h3 className="hidden md:block text-xl md:text-3xl font-bold text-cyan-500">{feature.subheader}</h3>
