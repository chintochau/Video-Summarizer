  ...
  return (
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl text-5xl font-display font-medium tracking-tight text-slate-900 sm:text-7xl">
        Your Shortcut to Knowledge: Video
        <span className="relative whitespace-nowrap text-indigo-600">
          ...
          <span className="relative"> Key Notes </span>
        </span>{" "}
        Simplified
      </h1>
      <p className="mx-auto mt-6 max-w-2xl text-lg  text-slate-700 font-normal font-roboto">
        Extract and summarize key points from any video, saving you hours of
        note-taking. Perfect for students, professionals, and content creators.
      </p>
