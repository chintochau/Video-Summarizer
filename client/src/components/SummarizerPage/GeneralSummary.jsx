    ...
    return (
      ...
      <Helmet>
        ...
        <div className="w-full px-2 pt-16 pb-20 md:py-40">
          ...
          <p
          className="w-full px-1  text-left text-sm md:text-lg text-gray-400 font-roboto font-normal max-w-3xl mx-auto"
          >
          ...
          <p 
          className="w-full px-1  text-left text-sm  text-gray-400 font-roboto font-normal max-w-3xl mx-auto py-2"
          >
            ...
            <div className="text-right">
              ...
              <Button variant="link" onClick={() => navigate("/login")} className="mx-auto text-cyan-600">Sign in now<ArrowRight /></Button>
            </div>
          </div>
        </div>
      </>
